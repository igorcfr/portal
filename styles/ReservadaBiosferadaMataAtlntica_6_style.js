var size = 0;
var placement = 'point';
function categories_ReservadaBiosferadaMataAtlntica_6(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Amortecimento':
...
default:
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}),fill: new ol.style.Fill({color: 'rgba(101,214,177,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_ReservadaBiosferadaMataAtlntica_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_ReservadaBiosferadaMataAtlntica_6(feature, value, size, resolution, labelText,
